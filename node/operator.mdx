...
```
git clone https://github.com/chainbase-labs/chainbase-avs-setup && cd chainbase-avs-setup
```
...
```
 ...
 Also ensure that the specific folders exist that the docker user has the correct write permissions
```
