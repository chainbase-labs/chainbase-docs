...
A flat 100 CBU is deducted the moment a query is submitted and accepted for execution, regardless of query complexity, scanned bytes, or runtime — and regardless of the query's eventual outcome.
