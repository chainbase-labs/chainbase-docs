...
title: 'Abstracted'
---
## 1. optimism.erc1155_approval_for_all
### Table Description
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/columns/optimism.erc1155_approval_for_all"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/data/optimism.erc1155_approval_for_all"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
## 1. optimism.erc1155_transfer_batch
### Table Description
ERC1155_transfer_batch in blockchain data refers to a batch transfer operation using the ERC1155 standard on a blockchain network, particularly optimism. ERC1155 is a multi-token standard that allows for the creation and management of multiple types of tokens, including fungible (like ERC20) and non-fungible tokens (like ERC721), within a single contract.In the ERC1155 standard, the transferBatch function enables users to transfer multiple types of tokens to several recipients in a single transaction. This approach is efficient as it reduces the number of transactions that need to be sent, thus saving on transaction fees and reducing congestion on the blockchain.
### Column Descriptions

<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/columns/optimism.erc1155_transfer_batch"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/data/optimism.erc1155_transfer_batch"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
## 1. optimism.erc1155_transfer_single
### Table Description
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/columns/optimism.erc1155_transfer_single"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/data/optimism.erc1155_transfer_single"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/columns/optimism.erc1155_uri"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/data/optimism.erc1155_uri"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/columns/optimism.erc20_approval"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/data/optimism.erc20_approval"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/columns/optimism.erc20_balances"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/data/optimism.erc20_balances"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
## 1. optimism.erc20_balances_historical
### Table Description
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/columns/optimism.erc20_balances_historical"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/data/optimism.erc20_balances_historical"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
## 1. optimism.erc20_transfer
### Table Description
The ERC20_transfer event is a fundamental component of the ERC20 token standard on the Ethereum blockchain. ERC20 tokens are fungible, meaning each token is identical to every other token of the same type, similar to traditional currencies. This standard is widely adopted for the creation of fungible digital assets on optimism. In ERC20, the transfer function and the corresponding Transfer event are critical for moving tokens from one account to another. This is the primary mechanism through which token balances are adjusted within the network.
### Column Descriptions

<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/columns/optimism.erc20_transfer"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/data/optimism.erc20_transfer"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/columns/optimism.erc721_approval"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/data/optimism.erc721_approval"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
## 1. optimism.erc721_approval_for_all
### Table Description
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/columns/optimism.erc721_transfer"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/data/optimism.erc721_transfer"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
## 1. optimism.nft_holder_historical
### Table Description
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/columns/optimism.nft_holders"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/data/optimism.nft_holders"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/columns/optimism.token_metas"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/data/optimism.token_metas"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/columns/optimism.token_prices"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/data/optimism.token_prices"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
## 1. optimism.token_prices_latest
### Table Description
Token prices in the context of cryptocurrencies and blockchain refer to the market value of a specific digital token or cryptocurrency. These prices are dynamic and can fluctuate significantly based on a variety of factors. Here are key points to understand about token prices:Supply and Demand: Like any market, token prices are largely driven by supply and demand. Limited supply and high demand can increase a token's price, while excess supply and low demand can decrease it.Market Sentiment: Investor sentiment, which can be influenced by news, social media, and market trends, plays a significant role in the pricing of tokens.
### Column Descriptions
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/columns/optimism.token_prices_latest"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/data/optimism.token_prices_latest"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
