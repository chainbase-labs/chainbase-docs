...
<div>
    <iframe
        src="https://doc-embed-app.chainbasehq.com/data/ethereum.trace_calls_decoded"
        width="100%"
        height="300px"
        frameBorder="0"
        scrolling="no"
...
## 2. ethereum.transaction_logs_decoded
