...
<CardGroup cols={3}>
    ...
    <Card title="Decoded" icon="code" href="./Decoded">
        TON Decoded, decoded transaction data, facilitating easier analysis and deeper understanding of smart contract operations.
    </Card>

    <Card title="Abstracted" icon="head-side-gear" href="./Abstracted">
