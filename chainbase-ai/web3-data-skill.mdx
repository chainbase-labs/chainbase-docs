...
```bash
claude skill install https://raw.githubusercontent.com/chainbase-labs/web3-data-skill/main/skills.sh
```

Or clone the repository and install manually:

```bash
git clone https://github.com/chainbase-labs/web3-data-skill.git
cd web3-data-skill
...
- zkSync
- Fantom
- And [90+ more chains](/platform/supported-networks/supported-networks)
...
- [GitHub Repository](https://github.com/chainbase-labs/web3-data-skill) — Source code and contributions
