...
```mermaid
graph TD
    ZoneOwner[Zone Owner] -->|1. Create Data Scenario| ZoneCreation[Zone Creation]
    ZoneCreation -->|2. Define Specs| Specs[Zone Specifications]
    Specs -->|3. Dev Invitation| Alchemist[Alchemist]
    Alchemist -->|4. Dev & Deploy| Manuscript[Manuscript]
    Manuscript -->|5. Submit Review| Review[Zone Owner Review]
    Review -->|6. Approval| Update[Zone Update]
    Update -->|7. Open Access| Operator[Operator]
    Operator -->|8. Select & Run| Operation[Zone Operation]
    Operation -->|9. Compute Contribution| Reward[Reward Distribution]
```
